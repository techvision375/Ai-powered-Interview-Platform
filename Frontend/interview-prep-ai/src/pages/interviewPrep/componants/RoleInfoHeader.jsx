  ...
  return (
    <div className="bg-white relative">
      <div className="container mx-auto px-10 md:px-0">
            ...
            <div className="flex-grow">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-medium text-gray-900 mt-1">
                    {topicsFocus}
                  </p>
                </div>
              </div>
        ...
        <div className="w-[full] md:w-[30vw] h-[199px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0 ">
